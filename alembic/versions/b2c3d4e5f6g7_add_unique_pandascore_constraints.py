...
def upgrade():
    ...
    dup_contest = conn.execute(
        sa.text(
            ...
            "WHERE pandascore_league_id IS NOT NULL AND pandascore_serie_id IS NOT NULL "  # noqa: E501
            "GROUP BY pandascore_league_id, pandascore_serie_id HAVING COUNT(1) > 1) AS t"  # noqa: E501
        )
    ).scalar()
