...
class TestDatabase(unittest.IsolatedAsyncioTestCase):
    ...
    # --- Tests for Database._create_connection ---
    ...
    # --- Tests for Database.execute_many ---
    ...
    # --- Tests for Database.close_all_connections ---
